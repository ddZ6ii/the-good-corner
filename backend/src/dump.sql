-- ______ REMOVE EXITSING TABLES ______-- 
...
-- ______ CREATE TABLES ______-- 
CREATE    TABLE category ("id" SERIAL NOT NULL PRIMARY KEY, "name" TEXT NOT NULL);

CREATE    TABLE tag ("id" SERIAL NOT NULL PRIMARY KEY, "name" TEXT NOT NULL);
