...
import { AdEditor } from '@/components'
import { GET_AD } from '@/graphql/ad'
import { UPDATE_AD } from '@/graphql/updateAd'
import { IdInput, UpdateAdInput } from '@/gql/graphql'
import { PageContent } from '@/layouts'
import { initialFormState } from '@/reducers'
import { AdPartialContentSchema } from '@/schemas'
import { IdParamSchema } from '@/schemas'
import { AdFormData } from '@/types'
import { mapAdToFormData, notifySuccess } from '@/utils'
...
export default function EditAdPage() {
  ...
  return (
    <PageContent title="Edit your ad">
